...
$query3 = "";
function db3($string) {
	global $query3, $database_link;
	$query3 = mysqli_query($database_link, $string) or die("Failure in db3 function: " . mysqli_error($database_link));
}

function dbr3() {
	global $query3;
	return mysqli_fetch_array($query3);
}

function dbo($string) {
	global $database_link;
	$temp = mysqli_query($database_link, $string) or die("Failure in dbo function: " . mysqli_error($database_link));
